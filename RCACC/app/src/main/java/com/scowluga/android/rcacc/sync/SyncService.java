 ...
 *
 * <p>Note: The SyncService itself is not notified when a new sync occurs. It's role is to manage the
 * lifecycle of our {@link SyncAdapter} and provide a handle to said SyncAdapter to the OS on request.
 */
