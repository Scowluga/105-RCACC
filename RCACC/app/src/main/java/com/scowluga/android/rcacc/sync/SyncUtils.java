...
import com.scowluga.android.rcacc.sync.accounts.GenericAccountService;
...
public class SyncUtils {
    private static final long SYNC_FREQUENCY = 60;  // 1 minute (in seconds)
...
//        Account[] accounts = accountManager.getAccounts();
    ...
    public static void TriggerRefresh() {
        final Account account = GenericAccountService.GetAccount();
        Bundle b = new Bundle();
        // Disable sync backoff and ignore sync preferences. In other words...perform sync NOW!
        b.putBoolean(ContentResolver.SYNC_EXTRAS_MANUAL, true);
        b.putBoolean(ContentResolver.SYNC_EXTRAS_EXPEDITED, true);
        ContentResolver.requestSync(account, FeedContract.CONTENT_AUTHORITY, b); // content authority
    }
